...
3. Budget: at most {{MAX_SEARCHES}} searches. Stop as soon as you can answer with
   two independent sources, or as soon as it is clear the answer is not out there.
...
```json
{"claim":"…","dimension":"{{DIMENSION_IDS}}","question":"{{OBJECTIVE}}","sources":[{"source":"…","url":"…","tier":1,"as_of":"YYYY-MM-DD"}],"as_of":"YYYY-MM-DD","agent":"{{SLUG}}","volatile":false}
```
