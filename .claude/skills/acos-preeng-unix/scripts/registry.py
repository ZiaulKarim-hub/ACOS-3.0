#!/usr/bin/env python3
"""
registry.py — cross-tree component reuse registry for acos-preeng-unix.
...
def cmd_link(args):
    ...
    setter = os.path.normpath(os.path.join(here, "..", "..", "acos-execute-component", "scripts", "set-status.py"))
