# Commands Migration Map (Archived)

The old `.claude/commands/` slash commands were migrated to native Claude Code skills on Feb 6, 2026.

## Migration Map

| Old Command | New Skill |
|------------|-----------|
| `acos-start.md` | `.claude/skills/acos-start/SKILL.md` |
| `acos-plan.md` | `.claude/skills/acos-plan/SKILL.md` |
